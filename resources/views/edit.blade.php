    ...
    <div class="mx-4">
        <div class="bg-gray-50 border border-gray-200 p-10 rounded max-w-lg mx-auto mt-24">
            <header class="text-center">
                ...
                <p class="mb-4">Edit Post To show updated details</p>
            </header>
            ...
            <form action="{{ route('update', $listing->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="file" class="border border-gray-200 rounded p-2 w-full" name="logo" id="image" />
                    @error('logo')
                        <p class="text-red-500 mt-2">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <img class="hidden w-48 mr-6 md:block " id="showImage"
